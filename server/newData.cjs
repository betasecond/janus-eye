...
module.exports = {
  ...
  mockPerformanceStats: mockPerformanceStats,
  mockStorageObjects,
  mockSubmissions,
  mockKnowledgePoints,
  
  // 旧API格式（兼容）
  mockUsersOld: mockUsersOld,
  mockCoursesOld: mockCoursesOld,
  mockQuestionsOld: mockQuestionsOld,
  mockAssignmentsOld: mockAssignmentsOld,
  mockNotificationsOld: mockNotificationsOld,
  mockPerformanceStatsOld: mockPerformanceStatsOld,
  mockSyllabus,
  mockStudentAnalysis,
  mockResources,
  teacherMenuItems,
